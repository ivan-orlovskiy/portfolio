...
class CardEditionDialog extends StatefulWidget {
  static const pageName = '/card_edition_dialog';
  final String name;
  final String icon;
  final String data;
  final Function(String name, String icon, String data) creationFunction;

  const CardEditionDialog({
    super.key,
    required this.name,
    required this.icon,
    required this.data,
  ...
  @override
  State<CardEditionDialog> createState() => _CardEditionDialogState();
}

class _CardEditionDialogState extends State<CardEditionDialog> {
  ...
  void initState() {
    ...
    _cardDataController.text = widget.data;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildCardField(_cardDataController, Lang.cardData),
                    IconSelector(
                      key: _iconState,
                    ...
                    AppButton(
                      ...
                      onPressed: () {
                        ...
                        if (widget.name == _cardNameController.text &&
                            widget.icon ==
                                (_iconState.currentState?.icon ?? 'cart') &&
                            widget.data == _cardDataController.text) {
                          FlushbarFactory.warningFlushBar(
                            message: Lang.sameCard,
                          ).show(context);
                          return;
                        }
                        ...
                        Navigator.popUntil(
                          context,
                          (route) =>
                              route.settings.name == CardEditionDialog.pageName,
                        );
